...
/**
 * The controller class for the Mapper
 * 
 * CHANGES:
 ...
 * @version 4.0.0 May 27 2015 (new branch from PDFCrawlController.java)
 *
 */
...
public class MapperController {
	...
	public static void main(String[] args) throws Exception {
		...
		for(String line: lines){
			...
			Mapper.configure(url.trim(), storageFolder, folder.trim());
			controller.start(Mapper.class, numberOfCrawlers);
