...
public class Downloader {
  ...
  public static void main(String[] args) {
    ...
    downloader.processUrl("http://www.sustainalytics.com");
  }
      ...
      if (parseData != null) {
        if (parseData instanceof HtmlParseData) {
         ...
         // System.out.println("Text length: {}" + htmlParseData.getText().length());
          System.out.println("Text: {}" + htmlParseData.getText());
          if(StringUtils.containsIgnoreCase(htmlParseData.getText(), "Sustainalytics"))
        	  System.err.println("YAY! FOUND!!");
